...
open class FlowLayoutPlugin: Plugin {
    ...
    public func layoutAttributes(in section: Int, offset: inout CGPoint, layout: PluginLayout) -> [UICollectionViewLayoutAttributes] {
        ...
        let attributes = sectionItems(in: section, layout: layout, offset: &offset)
    ...
    func sectionItems(in section: Int, layout: PluginLayout, offset: inout CGPoint) -> [UICollectionViewLayoutAttributes] {
        switch layout.scrollDirection {
        case .vertical: return verticalSectionItems(in: section, layout: layout, offset: &offset)
        case .horizontal: return horizontalSectionItems(in: section, layout: layout, offset: &offset)
        @unknown default: return []
        }
    }
    
    func verticalSectionItems(in section: Int, layout: PluginLayout, offset: inout CGPoint) -> [UICollectionViewLayoutAttributes] {
    ...
    func horizontalSectionItems(in section: Int, layout: PluginLayout, offset: inout CGPoint) -> [UICollectionViewLayoutAttributes] {
        guard let collectionView = layout.collectionView else { return [] }
        let sectionParameters = self.sectionParameters(inSection: section, layout: layout)
        let contentBounds = layout.contentBounds
